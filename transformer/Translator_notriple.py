...
from transformer.Models_notriple import Transformer_answerfeature,Transformer_bert
...
class Translator(object):
    ...
    def translate_batch(self, src_seq, src_pos, src_mask, src_seg_ids, src_triples):
        ...
        with torch.no_grad():
            ...
            src_enc = self.model(src_seq, src_pos, src_mask, src_seg_ids, None, None, src_triples, getencoder=True)
