...
from transformer.Models import Transformer_answerfeature,Transformer_bert
...
class Translator(object):
    ...
    def translate_batch(self, src_seq, src_pos,src_mask, ans_id_seq,ans_id_pos, ans_id_mask, turn_emb_seq, turn_emb_pos, turn_emb_mask):
        ...
        with torch.no_grad():
            #-- Encode
            src_seq, src_pos,src_mask,ans_id_seq,turn_emb_seq = src_seq.to(self.device), src_pos.to(self.device),src_mask.to(self.device),ans_id_seq.to(self.device),turn_emb_seq.to(self.device)

            src_enc, *_ = self.model.encoder(src_seq, token_type_ids=ans_id_seq,attention_mask=src_mask, output_all_encoded_layers=False)
